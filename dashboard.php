...
// (Kode PHP Anda untuk mengambil data $events, $total_pages, dll. tetap sama)
$events = [];
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg overflow-x-auto">
                <?php if (empty($events)): ?>
                    <div class="text-center py-8">
                        <p class="text-gray-500 text-lg">Anda belum membuat event apapun.</p>
                    </div>
                <?php else: ?>
                    <table class="w-full text-left table-auto min-w-[768px]">
                        <thead>
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-3">
                                            <a href="detail_event.php?id=<?php echo $event['event_id']; ?>" class="text-green-600 hover:underline font-medium text-sm">Detail</a>
